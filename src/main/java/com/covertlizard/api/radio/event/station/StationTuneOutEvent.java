...
public class StationTuneOutEvent extends Event implements Cancellable
{
     ...
     * @param player the player that is tuning in
     */
    public StationTuneOutEvent(MusicStation musicStation, Player player)
    {
