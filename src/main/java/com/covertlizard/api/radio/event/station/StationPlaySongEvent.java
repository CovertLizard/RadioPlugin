...
public class StationPlaySongEvent extends Event implements Cancellable
{
     ...
     */
    public StationPlaySongEvent(MusicStation musicStation, String songName)
    {
